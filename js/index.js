...
var veryRare = ["Pikachu" = {name: 'Pikachu',type: 'electric'}, "Raichu" = {name: 'Raichu',type: 'electric'}, "Vulpix" = {name: 'Vulpix',type: 'fire'}, "Ninetales" = {name: 'Ninetales',type: 'fire'}, "Jigglypuff" = {name: 'Jigglypuff',type: 'normal & fairy'}, "Wigglytuff" = {name: 'Wigglytuff',type: 'normal & fairy'}, "Psyduck" = {name: 'Psyduck',type: 'water'}, "Golduck" = {name: 'Golduck',type: 'water'}, "Growlithe" = {name: 'Growlithe',type: 'fire'}, "Arcanine" = {name: 'arcanine',type: 'fire'}, "Abra" = {name: 'Abra',type: 'psychic'}, "Kadabra" = {name: 'Kadabra',type: 'psychic'}, "Alakazam" = {name: 'Alakazam',type: 'psychic'}, "Ponyta" = {name: 'Ponyta',type: 'fire'}, "Rapidash" = {name: 'Rapidash',type: 'fire'}, "Slowpoke" = {name: 'Slowpoke',type: 'water & psychic'}, "Slowbro" = {name: 'Slowbro',type: 'water & psychic'}, "Doduo" = {name: 'Doduo',type: 'normal & flying'}, "Dotrio" = {name: 'Dotrio',type: 'normal & flying'}, "Seel" = {name: 'seel',type: 'water'}, "Dewgong" = {name: 'Dewgong',type: 'water & ice'}, "Exeggcute" = {name: 'Exeggcute',type: 'grass & psychic'}, "Exeggutor" = {name: 'Exeggutor',type: 'grass & psychic'}, "Cubone" = {name: 'Cubone',type: 'ground'}, "Marowak" = {name: 'Marowak',type: 'ground'}, "Chansey" = {name: 'Chansey',type: 'normal'}, "Tangela" = {name: 'Tangela',type: 'grass'}, "Seadra" = {name: 'Seadra',type: 'water'}, "Staryu" = {name: 'Staryu',type: 'water'}, "Starmie" = {name: 'Starmie',type: 'water & psychic'}, "Jynx" = {name: 'Jynx',type: 'ice & psychic'}, "Magmar" = {name: 'Magmar',type: 'fire'}, "Tauros" = {name: 'Tauros',type: 'normal'}, "Ditto" = {name: 'Ditto',type: 'normal'}, "Chinchou" = {name: 'Chinchou',type: 'water & electric'}, "Lanturn" = {name: 'Lanturn',type: 'water & electric'}, "Pichu" = {name: 'Pichu',type: 'electric'}, "Igglybuff" = {name: 'Igglybluff',type: 'normal & fairy'}, "Natu" = {name: 'Natu',type: 'psychic & flying'}, "Xatu" = {name: 'Xatu',type: 'psychic & flying'}, "Mareep" = {name: 'Mareep',type: 'electric'}, "Flaaffy" = {name: 'Flaaffy',type: 'electric'}, "Ampharos" = {name: 'Ampharos',type: 'electric'}, "Bellossom", "Yanma" = {name: 'Yanma',type: 'bug & flying'}, "Wobbuffet" = {name: 'Wobuffet',type: 'psychic'}, "Girafarig" = {name: 'Girafarig',type: 'normal & psychic'}, "Teddiursa" = {name: 'Teddiursa',type: 'normal'}, "Ursaring" = {name: 'Ursaring',type: 'normal'}, "Corsola" = {name: 'Corsola',type: 'water & rock'}, "Mantine" = {name: 'Mantine',type: 'water & flying'}, "Houndour" = {name: 'Houndour',type: 'dark & fire'}, "Houndoom" = {name: 'Houndoom',type: 'dark & fire'}, "Kingdra" = {name: 'Kingdra',type: 'water & dragon'}, "Phanpy" = {name: 'Phanpy',type: 'ground'}, "Donphan" = {name: 'Donphan',type: 'ground'}, "Porygon2" = {name: 'Porygon2',type: 'normal'}, "Magby" = {name: 'Magby',type: 'fire'}, "Miltank" = {name: 'Miltank',type: 'normal'}, "Blissey" = {name: 'Blissey',type: 'normal'}];
var extremelyRare = ["Bulbasaur" = {name: 'Bulbasaur',type: 'grass & poison'}, "Ivysaur" = {name: 'Ivysaur',type: 'grass & poison'}, "Venusaur" = {name: 'Venusaur',type: 'grass & poison'}, "Charmander" = {name: 'Charmander',type: 'fire'}, "Charmeleon" = {name: 'Charmeleon',type: 'fire'}, "Charizard" = {name: 'Charizard',type: 'fire & flying'}, "Squirtle" = {name: 'Squirtle',type: 'water'}, "Wartortle" = {name: 'Wartortle',type: 'water'}, "Blastoise" = {name: 'Blastoise',type: 'water'}, "Machoke" = {name: 'Machoke',type: 'fighting'}, "Machamp" = {name: 'Machamp',type: 'fighting'}, "Farfetch'd" = {name: 'Farfetched',type: 'normal & flying'}, "Onix" = {name: 'Onix',type: 'rock & ground'}, "Hitmonlee" = {name: 'Hitmonlee',type: 'fighting'}, "Hitmonchan" = {name: 'Hitmonchan',type: 'fighting'}, "Rhyhorn" = {name: 'Rhyhorn',type: 'ground & rock'}, "Rhydon" = {name: 'Rhydon',type: 'ground & rock'}, "Kangaskhan" = {name: 'Kangaskhkan',type: 'normal'}, "Scyther" = {name: 'Scyther',type: 'bug & flying'}, "Electabuzz" = {name: 'Electrabuzz',type: 'electric'}, "Pinsir" = {name: 'Pinsir',type: 'bug'}, "Snorlax" = {name: 'Snorlax',type: 'normal'}, "Dratini" = {name: 'Dratini',type: 'dragon'}, "Dragonair" = {name: 'Dragonair',type: 'dragon'}, "Dragonite" = {name: 'dragonite',type: 'dragon flying'}, "Chikorita" = {name: 'Chikorita',type: 'grass'}, "Bayleef" = {name: 'Bayleef',type: 'grass'}, "Meganium" = {name: 'Meganium',type: 'grass'}, "Cyndaquil" = {name: 'Cyndaquil',type: 'fire'}, "Quilava" = {name: 'Quilava',type: 'fire'}, "Typhlosion" = {name: 'Typhlosion',type: 'fire'}, "Totodile" = {name: 'Totodile',type: 'water'}, "Croconaw" = {name: 'Croconaw',type: 'water'}, "Feraligatr" = {name: 'Feraligatr',type: 'water'}, "Sudowoodo" = {name: 'Sudowoodo',type: 'rock'}, "Politoed" = {type:'water'}, "Gligar" = {name: 'Gligar',type: 'ground & flying'}, "Steelix" = {name: 'Steelix',type: 'ground & steel'}, "Snubbull" = {name: 'Snubbull',type: 'fairy'}, "Heracross" = {name: 'Heracross',type: 'bug & fighting'}, "Sneasel" = {name: 'Sneasel',type: 'dark & ice'}, "Swimub" = {name: 'Swimub',type: 'ice & ground'}, "Piloswine" = {name: 'Piloswine',type: 'ice & ground'}, "Skarmory" = {name: 'Skarmory',type: 'steel & flying'}, "Elekid" = {name: 'Elekid',type: 'electric'}];
var legendary = ["Articuno" = {name: 'Articuno',type: 'ice & flying'}, "Zapdos" = {name: 'Zapdos',type: 'electric & flying'}, "Moltres" = {name: 'Moltres',type: 'fire &  flying'}, "Mewtwo" = {name: 'Mewtwo',type: 'psychic'}, "Mew" = {name: 'mew',type: 'psychic'}, "Raikou" = {name: 'Raikou',type: 'electric'}, "Entei" = {name: 'Entei',type: 'fire'}, "Suicune" = {name: 'Suicune',type: 'water'}, "Lugia" = {name: 'Lugia',type: 'psychic & flying'}, "Ho-Oh" = {name: 'Ho-Oh',type: 'fire & flying'}];
